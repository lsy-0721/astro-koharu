...
updated: 2026-09-17 14:12:04
categories:
  - [前端]
description: 没有漂亮的五官，谁又愿意去了解你的三观
...
可以把行内块元素（inline-block）理解成：

> “排队的时候像行内元素，设置大小的时候像块元素。”

这是理解 inline-block 最简单的一句话。

***

#### `inline-block` 是什么？

`inline-block` 就是把两者结合起来。
...
其中 `inline-block` 可以理解成：

**“小盒子排成一排，而且每个小盒子的宽度、高度都可以自己控制。”**
